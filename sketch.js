...
ballD = 40
colors = ['lime', 'skyblue', 'red', 'yellow' ]
let p1, p2
...
function draw() {
  ...
  p2.update()
   ...
   let watermarkText = "Нургалиева Алия";
  let watermarkSize = 12;
  let watermarkColor = color( 255);
  let watermarkX = 10;
  let watermarkY = height -10;

      fill(watermarkColor);
    textSize(watermarkSize);
    textAlign(LEFT, BOTTOM);
    text(watermarkText, watermarkX, watermarkY);
}
